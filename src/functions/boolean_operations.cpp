...
{
    BooleanOperations::register_relational_ops();

    Functions::specialFormMap["if"] = BooleanOperations::if_func;
    Functions::specialFormMap["cond"] = BooleanOperations::cond_func;

    Functions::funcMap["not"] = BooleanOperations::not_func;
    Functions::specialFormMap["and"] = BooleanOperations::and_func;
    Functions::specialFormMap["or"] = BooleanOperations::or_func;
}
